...
Le chantier est volontairement découpé en parties indépendantes. On peut traiter 01 et 02 séparément. On ajoute `03-…` etc. si d'autres instabilités apparaissent (à capturer via [INBOX.md](../../INBOX.md)).
