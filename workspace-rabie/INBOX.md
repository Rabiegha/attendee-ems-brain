...
- 🔵 [ops][post-event] **GitHub branch protection / gouvernance repos reportée après LFD 2026** : décision 15/07 = ne pas prendre GitHub Pro sur le compte perso dans le rush. Option retenue post-event : créer une organisation GitHub Attendee, transférer les repos, centraliser teams/secrets/rulesets/branch protection. Raison du report : éviter de toucher ownership, accès, secrets et CI/CD pendant la fenêtre event. Détail → [migration org GitHub](../backlog/a-faire/other/migrations%20and%20refactoring/migration-GCP/MIGRATION_GITHUB_ORGANIZATION.md) + [finalisation §5](../workstreams/en-cours/lfd2026/0-fondations/finalisation-ci-cd-et-livraison.md).
