...
- Garder la solution compatible avec BullMQ/Redis et future event-driven (cf. workstream [async-architecture](../../../workstreams/a-faire/async-architecture/README.md)).
