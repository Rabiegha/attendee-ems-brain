...
- Le QandA Async Architecture les liste explicitement ([../async-architecture/QandA/05-coupling-and-side-effects.md](../workstreams/async-architecture/QandA/05-coupling-and-side-effects.md), [../async-architecture/QandA/13-information-gaps.md](../workstreams/async-architecture/QandA/13-information-gaps.md)).
...
- La couverture de tests est faible / incertaine (cf. [../async-architecture/QandA/11-observability-testing.md](../workstreams/async-architecture/QandA/11-observability-testing.md)) — pas de filet.
...
- Cible des refactors documentée dans [../backlog/refactoring-cleanup.md](../backlog/refactoring-cleanup.md).
...
- [../async-architecture/QandA/11-observability-testing.md](../workstreams/async-architecture/QandA/11-observability-testing.md)
- [../backlog/refactoring-cleanup.md](../backlog/refactoring-cleanup.md)
