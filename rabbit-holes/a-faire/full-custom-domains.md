...
- **WebSocket** : sticky session + CORS + Origin check à recalibrer (déjà permissif aujourd'hui, voir [../bugs/cors-origin-security-review.md](../../bugs/a-faire/cors-origin-security-review.md)).
- **Public namespaces** ([../backlog/public-landing-page-namespaces.md](../../backlog/a-faire/public-landing-page-namespaces.md)) ne sont pas encore implémentés → on ferait l'étape 3 sans avoir fait l'étape 1.
...
- **Pas maintenant.**
- Démarrer d'abord par les **Public Namespaces** (sous-domaines `*.attendee.app`) — voir [../backlog/public-landing-page-namespaces.md](../../backlog/a-faire/public-landing-page-namespaces.md).
...
- [../backlog/public-landing-page-namespaces.md](../../backlog/a-faire/public-landing-page-namespaces.md)
- [../steering/DECISIONS.md](../../../attendee-ems-back/docs/steering/DECISIONS.md#public-namespaces)
...
- Autorisé : compléter la fiche [../backlog/public-landing-page-namespaces.md](../../backlog/a-faire/public-landing-page-namespaces.md) avec ce qu'il faudra prévoir un jour.
